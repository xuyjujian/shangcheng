<template>
  <div class="df jc_b ai_c homeHead pr">
    ...
    <div class="box">
      <van-search v-model="value" show-action placeholder="请输入搜索关键词" @input="onSearch" @click="clk" class="pl">
        <template #action>
...
export default {
  ...
  methods: {
    clk(){
      this.history = this.user.nickname + "search";
      this.historyserach = JSON.parse(localStorage.getItem(this.history));
    },
    getsearch() {
