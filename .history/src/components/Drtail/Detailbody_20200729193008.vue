    ...
    like() {
     ...
     getbrowse() {
      ...
      if (localStorage.getItem(name)) {
        ...
        console.log(browse,'123');
        // browse=browse.filter((item,index,array)=>{
        //   return   array.indeof(item.id)===index
        // })
        localStorage.setItem(name, JSON.stringify(browse));
      } else {
        let browse = [];
        browse.push(this.goods.goodsOne);
        localStorage.setItem(name, JSON.stringify(browse));
