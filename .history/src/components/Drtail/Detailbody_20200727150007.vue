...
export default {
  ...
  methods: {
    like() {
      if (this.user) {
        let uesrname=this.user.nickname+"collection"
        if (this.num % 2 === 0) {
          this.$api
                ...
                this.$api
                  ...
                  .then((res) => {
                    if (res.code === 200) {
                      ...
                      if (localStorage.uesrname) {
                        let collection = JSON.parse(
                          localStorage.getItem(uesrname)
                        );
                        collection.map(item=>{
            ...
            .then((res1) => {
              if (res1.code === 200) {
                this.$api
                  ...
                  let collection = JSON.parse(localStorage.getItem(uesrname));
                collection.map((item) => {
                  if (item.name===this.user.nickname) {
                ...
                localStorage.setItem(uesrname, JSON.stringify(collection));
