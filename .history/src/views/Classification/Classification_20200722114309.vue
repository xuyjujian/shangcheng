      ...
      <div class="df">
        ...
        <div>
          <div style="width: 290px;">
            <van-tabs :ellipsis='false' animated v-model="active">
             <van-tab v-for="(item,index) in bxMallSubDto" :key='index' :title="item.mallSubName" @click="dataList1(item)">123</van-tab>
            </van-tabs>
          </div>
          <div></div>
        </div>
