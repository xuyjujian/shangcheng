<template>
  <div>
    ...
    <Paydetail :idDirect="idDirect" :address='address' v-if="idDirect===true&&address"></Paydetail>
    <Paycar :idDirect="idDirect" :address="address" :goodslist="goodslist" v-if="idDirect===false&&address"></Paycar>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    console.log(this.goodslist,"zxc")
