<template>
  <div>
    ...
    <Paydetail :idDirect1="idDirect1" :address='address' v-if="idDirect1===1&&address"></Paydetail>
    <Paycar  :address="address" :idDirect1="idDirect1"  v-if="idDirect1===0"></Paycar>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    this.idDirect1=this.$route.query.idDirect
    console.log(this.idDirect1,'0')
