<template>
  <div>
    ...
    <div class="df mt ml" v-if="this.detail.goods">
      <div>
        <img :src="this.detail.goods[0].image" alt />
      </div>
      <div>{{this.detail.goods[0].name}}</div>
      <div class="shopping df jc_c ai_c">
        <van-icon name="shopping-cart-o" size="30" color="#FF3130" />
      </div>
    </div>
    <div class="box df ai_e jc_c">
      <div>
